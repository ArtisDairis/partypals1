...
<div id="registerModal" class="modal">
    <div class="modal-content1">
        ...
        <div class="register_box">
            <h2>Reģistrēšanās</h2>
            <button type="button" id="userReg_btn" class="reg_btn" onclick="registerUser()">Lietotājs</button>
            <button type="button" id="animReg_btn" class="reg_btn" onclick="registerAnimators()">Darbinieks</button>
            <hr>
            <div id="userReg">
                <form method="post" id="registrationFormUser">
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž0-9]+" id="username_reg" class="input1" name="username" placeholder="Lietotājvārds" required><br>
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž]+" title="Jūsu vārds, piemēram: Jānis" class="input2" name="name" placeholder="Vārds" required>
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž]+" title="Jūsu uzvārds, piemēram: Ziediņš" class="input2" name="surname" placeholder="Uzvārds" required>
                    <br>
                    ...
                    <input type="text" pattern=".*@.*" title="E-pasts tika nepareizi uzrakstīts!" id="e_pasts" class="input2" name="e_pasts" placeholder="E-pasts" required>
                        <br>
                    <input type="submit" id="submitBtnUser" value="Apstiprināt" class="modal_btn">
                </form>
            </div>
            <div id="animReg" hidden>
                <form method="post" id="registrationFormAnim">
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž0-9]+" id="username_reg1" class="input1" name="username" placeholder="Lietotājvārds" required><br>
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž]+" title="Jūsu vārds, piemēram: Jānis" class="input2" name="name" placeholder="Vārds" required>
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž]+" title="Jūsu uzvārds, piemēram: Ziediņš" class="input2" name="surname" placeholder="Uzvārds" required>
                    <br>
                    <input type="text" pattern="[0-9+]+" title="Var vadīt tikai ciparus!" id="phone1"  class="input2" name="phone_number" placeholder="Telefona numurs" value="+371" required>
                    <input type="text" pattern=".*@.*" title="E-pasts tika nepareizi uzrakstīts!" id="e_pasts1" class="input2" name="e_mail" placeholder="E-pasts" required>
                    <br>
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž0-9]+" title="Ierakstiet jūsu adresi" class="input1" name="adress" placeholder="Adrese" required>
                    <br>
                    <input type="text" pattern="[A-Za-zāčēģīķļņšūž]+" title="Personāžs, piemēram: \'Spider-Man\'" class="input2" name="my_character" placeholder="Personāžs" required>
                    <br>
                    <input type="submit" id="submitBtnAnim" value="Apstiprināt" class="modal_btn">
                </form>
            </div>
        </div>
    </div>
