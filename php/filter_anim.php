        ...
        <div class="panel">
            ...
            <?php
                    ...
                    if($result_theme->num_rows > 0)
                    {
                        echo '
                        <li class="list-group-item">
                            <i class="fa-solid fa-award border rounded ps-1 pt-1 pe-1 pb-1 me-2" style="color: #CCCCFF;"></i>
                            <label class="form-check-label" for="themeCheckboxAll" style="font-size: 14px;">Visas tēmas</label>
                            <input class="form-check-input me-1" type="radio" name="themeCheckbox" value="all" id="themeCheckboxAll" onchange="search_theme(`all`)" checked>
                        </li>
                        ';
                        while($row_theme = $result_theme->fetch_assoc())
                        {
                            ...
                            <li class="list-group-item">
                                ...
                                <input class="form-check-input me-1" type="radio" name="themeCheckbox" value="'.$row_theme['id'].'" id="themeCheckbox'.$row_theme['id'].'" onchange="search_theme(`'.$row_theme['id'].'`)">
                            </li>
                            ';
                        }
                    }
